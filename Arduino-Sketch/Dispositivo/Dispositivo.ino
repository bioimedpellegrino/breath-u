...
if(t_t_mov > 5000){
 ...
 Serial2.print("Nessun movimento rilevato da ");Serial.print(t_t_mov/1000);Serial.println(" s ");
  }
}  
...
filtraggio del segnale possiamo occuparci del controllo*/
        //Serial.print(G_x);Serial.println(" gradi/s");  
        Serial.print(angolo);Serial.println("°");
        if(Serial.available() > 0){  
        Serial2.print("Frequenza Respiratoria ");Serial2.print(frequenza_resp);Serial2.println(" respiri/min ");
       }

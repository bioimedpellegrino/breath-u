...
float GyroX = 0, GyroY = 0, GyroZ = 0, Gyro = 0;
float setGyroX = 0;
float setGyroY = 0;
float setGyroZ = 0;
...
void setup(){
  ...
  */
  ...
  for(int i = 0; i<100; i++) setGyroX = setGyroX + readGyroX();
  setGyroX = setGyroX / 100;
  for(int i = 0; i<100; i++) setGyroY = setGyroY + readGyroY();
  setGyroY = setGyroY / 100;
  for(int i = 0; i<100; i++) setGyroZ = setGyroZ + readGyroZ();
  setGyroZ = setGyroZ / 100;
  Serial.print("Offset X: ");
  Serial.print(setGyroX);
  Serial.println(" gradi/s");
  Serial.print("Offset Y: ");
  Serial.print(setGyroY);
  Serial.println(" gradi/s");
  Serial.print("Offset Z: ");
  Serial.print(setGyroZ);
  Serial.println(" gradi/s");
}
...
//Ripeto una volta ogni 5 secondi la lettura completa di giroscopio e accellerometro
  GyroX = readGyroX() - setGyroX;
  GyroY = readGyroY() - setGyroY;
  GyroZ = readGyroZ() - setGyroZ;
  Gyro = sqrt(GyroX*GyroX + GyroY*GyroY + GyroZ*GyroZ);
